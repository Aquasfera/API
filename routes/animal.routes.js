...
router.get('/animal/name/:name', async(req,res) => await getAllDataByName(req,res,Animal))
router.get('/animal/location/:location_id', async(req,res) => await getAllDataByLocation(req,res,Animal))
